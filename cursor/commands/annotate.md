...
# /annotate — Annotate a design (numbered, typed callouts + redlines) and write up the UX rationale.
...
- `~/.product-design-partner/agent/modules/workflows.md` → §17 UX Annotations & Write-ups
- `~/.product-design-partner/design-data/references/annotation-guide.md`
