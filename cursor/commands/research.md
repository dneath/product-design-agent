<!-- GENERATED from commands/research.md by scripts/sync-commands.mjs — edit the source, then re-run. -->

# /research — Plan, run, or synthesize research — assumption maps, interviews, JTBD, synthesis with confidence levels; take an idea to a defensible concept.
...
- `~/.product-design-partner/design-data/references/research-methods.md`
