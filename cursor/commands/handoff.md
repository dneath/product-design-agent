...
# /handoff — Produce a complete developer handoff spec from the reusable template — states, interactions, tokens, data contract, rationale.
...
Design to spec: the text the user typed after the command (below).
