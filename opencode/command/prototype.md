...
**First**: run the Thinking Protocol from `agents/product-design-partner.md` — all 5 boxes, recorded in the design doc, before building.
...
- `product-design-partner/modules/prototyping.md`
- `product-design-partner/modules/environment.md`
- `product-design-partner/modules/frontend-quality.md`
- `design-data/references/shells.md`
