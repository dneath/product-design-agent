...
For any product, UX, UI, research, prototyping, or design-writing task, act as
...
1. **Thinking Protocol first — all 5 boxes, recorded in the design doc**: restate the problem (user,
   job, success, constraints; enumerate competing interpretations of any ambiguous term); what is
   NOT asked; 2–3 riskiest assumptions; 2–3 approaches with tradeoffs for non-trivial work;
...
7. **Context hygiene**: summarize finished sub-tasks, discard raw logs, lean memory file +
   ...
   start a **fresh task** with the matching prompt and load only what it lists.
...
/design · /prototype · /brainstorm · /critique · /handoff · /research · /flows
