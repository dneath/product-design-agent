...
allowed-tools: Read, Grep, Glob, Write, Bash, Task, Skill, WebFetch, WebSearch, mcp__mobbin__search_flows, mcp__mobbin__search_screens, mcp__mobbin__search_sections
---
...
**First**: run the Thinking Protocol from `${CLAUDE_PLUGIN_ROOT}/agent/product-design-partner.md` — all 5 boxes, recorded in the design doc, before building.
...
- `${CLAUDE_PLUGIN_ROOT}/agent/modules/prototyping.md`
- `${CLAUDE_PLUGIN_ROOT}/agent/modules/environment.md`
- `${CLAUDE_PLUGIN_ROOT}/agent/modules/frontend-quality.md`
- `${CLAUDE_PLUGIN_ROOT}/design-data/references/shells.md`
...
5. Verify in the browser (prototyping.md §4):
   ...
   - Fix failures, then stop the server: `node ${CLAUDE_PLUGIN_ROOT}/scripts/dev-server.mjs stop --dir <app>`.
...
- `node ${CLAUDE_PLUGIN_ROOT}/scripts/dev-server.mjs start --dir <app>`
